...
public class CodeServiceGen {
	...
	private static String[] includeTables = {"goods_category"};
...
//        gc.setIdType(IdType.ASSIGN_ID);
        ...
        focList.add(new FileOutConfig("/com/tangdao/gen/service.xml.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/tangdao/modules/"+pc.getModuleName()+"/service/" + tableInfo.getEntityName() + "Service" + StringPool.DOT_JAVA;
            }
        });
        /*
...
//        strategy.setSuperServiceClass("com.tangdao.core.service.ICrudService");
