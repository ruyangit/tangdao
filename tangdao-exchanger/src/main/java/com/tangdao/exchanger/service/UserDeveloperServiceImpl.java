...
import org.tangdao.common.codec.DigestUtils;
...
import org.tangdao.modules.sys.mapper.UserDeveloperMapper;
...
@Slf4j
@Service
public class UserDeveloperServiceImpl extends CrudService<UserDeveloperMapper, UserDeveloper> implements IUserDeveloperService {
	...
	public UserDeveloper saveWithReturn(String userCode){
        ...
        developer.setAppSecret(EncodeUtils.encodeHex(DigestUtils.digest(developer.getUserCode().getBytes(), "SHA-1", developer.getSalt().getBytes(), 1)));
