...
public enum RuleType {
	...
	EMAIL("邮箱错误", com.tangdao.core.validate.parser.EmailParser.class),
	MOBILE("手机号错误", com.tangdao.core.validate.parser.MobileParser.class),
	PATTERN("正则校验失败", com.tangdao.core.validate.parser.MactchRegexParser.class),;
