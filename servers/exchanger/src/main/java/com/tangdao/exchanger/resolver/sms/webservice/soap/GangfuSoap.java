package org.tangdao.modules.exchanger.resolver.sms.webservice.soap;
...
public class GangfuSoap {
	...
	public static String soapXmlContent(Map<String, String> prams, String callMethod){
		...
		soapRequestData.append("<soapenv:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.hydxqxt.dp.iac\">")
			.append("<soapenv:Header/>")
			.append("<soapenv:Body>")
			.append(String.format("<ser:%s soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">", callMethod));
