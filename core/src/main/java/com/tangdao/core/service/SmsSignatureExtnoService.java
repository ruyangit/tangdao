...
import com.tangdao.core.model.domain.SmsSignatureExtno;
 ...
 * @since 2021年3月10日
 */
public class SmsSignatureExtnoService extends BaseService<SmsSignatureExtnoMapper, SmsSignatureExtno> {

	@Autowired
	private StringRedisTemplate stringRedisTemplate;

	public boolean save(SmsSignatureExtno signatureExtNo) {
	...
	public boolean update(SmsSignatureExtno signatureExtNo) {
		SmsSignatureExtno td = super.getById(signatureExtNo.getId());
		if (td == null) {
	...
	public boolean delete(String id) {
		SmsSignatureExtno signatureExtNo = super.getById(id);
	...
	public boolean reloadToRedis() {
		List<SmsSignatureExtno> list = super.list();
	...
	private String getFromDb(String userId, String content) {
		List<SmsSignatureExtno> list = super.list(
				Wrappers.<SmsSignatureExtno>lambdaQuery().eq(SmsSignatureExtno::getUserId, userId));
		if (CollUtil.isEmpty(list)) {
			return null;
		}
